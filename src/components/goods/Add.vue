  ...
  <div>
    ...
    <el-card>
      ...
      <el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-width="100px"
        label-position="top">
        <el-tabs :tab-position="'left'" v-model="activeIndex" :before-leave="beforeActiveLeave"
...
export default {
  data () {
    return {
      ...
      // 添加表单验证
      addFormRules: {
        goods_name: [{ required: true, message: '请输入商品名称', tiggle: 'blur' }],
        goods_price: [{ required: true, message: '请输入商品价格', tiggle: 'blur' }],
        goods_number: [{ required: true, message: '请输入商品数量', tiggle: 'blur' }],
        goods_weight: [{ required: true, message: '请输入商品重量', tiggle: 'blur' }],
  ...
  methods: {
    ...
    // 防止tabs越级
    beforeActiveLeave (activeName, oldActiveName) {
